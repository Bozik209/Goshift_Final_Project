 ...
 * {@link MA_Summary_Fragment.MA_SUMMARY_FIListener} interface
 * to handle interaction events.
 * Use the {@link MA_Summary_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MA_Summary_Fragment extends Fragment {
    ...
    private MA_SUMMARY_FIListener mListener;

    public MA_Summary_Fragment() {
     ...
     * @return A new instance of fragment MA_Summary_Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static MA_Summary_Fragment newInstance(String param1, String param2) {
        MA_Summary_Fragment fragment = new MA_Summary_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ma__summary_, container, false);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.MA_SUMMARY_FIListener(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof MA_SUMMARY_FIListener) {
            mListener = (MA_SUMMARY_FIListener) context;
        } else {
     ...
     */
    public interface MA_SUMMARY_FIListener {
        // TODO: Update argument type and name
        void MA_SUMMARY_FIListener(Uri uri);
    }
